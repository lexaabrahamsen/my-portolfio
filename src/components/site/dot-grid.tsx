export function DotGrid() {
  return (
    ...
    >
      <div className="absolute inset-0 animate-dot-drift bg-[radial-gradient(circle,theme(colors.foreground)_1px,transparent_1px)] bg-[length:28px_28px] opacity-[0.12]" />
