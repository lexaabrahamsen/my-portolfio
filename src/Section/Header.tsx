...
export default function Header({ id }: HeaderProps) {
  ...
  return (
    <aside className="relative overflow-hidden text-black rounded-lg" style={{ backgroundColor: darkMode ? '#1f2937' : 'white'}}>
      <div className="relative z-10 max-w-screen-xl px-4 pb-20 pt-10 sm:py-24 mx-auto sm:px-6 lg:px-8">
        <div className="max-w-4xl sm:mt-1 mt-80 space-y-8 text-center sm:text-left sm:ml-auto">
          <h2 className="font-outfit font-bold sm:text-8xl leading-8" style={{ color: darkMode ? 'white' : '#1f2937'}}>
          ...
          <div className="col-span-12 sm:col-span-3">
            <h3
              ...
              style={{ color: darkMode ? 'white' : '#1f2937', fontStyle: 'italic' }}
            >
