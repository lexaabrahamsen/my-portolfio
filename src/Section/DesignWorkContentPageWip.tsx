        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          ...
          <div className="w-full lg:w-5/12 flex flex-col justify-top">
            ...
            <p className="mt-6 text-xl leading-8 text-gray-700">
              ...
              leading brands be more data driven by re-designing and
              transforming the contracting relationship with consumers at global
              scale
            </p>
          </div>
          <div className="w-full lg:w-8/12">
            <img src="../HU2.png" className="w-full rounded-lg mb-5" />
            <img src="../HU1.png" className="w-full rounded-lg mb-5" />
            <img src="../HU3.png" className="w-full rounded-lg mb-5" />
